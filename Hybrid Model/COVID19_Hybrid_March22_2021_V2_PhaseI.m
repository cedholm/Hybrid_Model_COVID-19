...
filename1 = ['Hybrid_COVID19_PeakInf_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
if exist(filename1, 'file')==2
  delete(filename1);
end
filename2 = ['Hybrid_COVID19_TimePeak_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
if exist(filename2, 'file')==2
  delete(filename2);
end
filename3 = ['Hybrid_COVID19_NumDeaths_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
if exist(filename3, 'file')==2
  delete(filename3);
end
filename4 = ['Hybrid_COVID19_ProbOutbreak_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
if exist(filename4, 'file')==2
  delete(filename4);
end
% filename5 = ['Hybrid_COVID19_ProbExtinct_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
% if exist(filename5, 'file')==2
%   delete(filename5);
% end
filename6 = ['Hybrid_COVID19_NumInf_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
if exist(filename6, 'file')==2
  delete(filename6);
end
filename7 = ['Hybrid_COVID19_TimeOutbreak_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
if exist(filename7, 'file')==2
  delete(filename7);
end
filename8 = ['Hybrid_COVID19_NumSilentInf_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
if exist(filename8, 'file')==2
  delete(filename8);
end
filename9 = ['Hybrid_COVID19_ProbICUoverload_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
if exist(filename9, 'file')==2
  delete(filename9);
end
filename10 = ['Hybrid_COVID19_NHPerrorfreq_OutbreakThresh_',outbreak_value_print,'_r',r_value_print,'_CV',CV_value_print,'_InitialCondition',num2str(InitialCondition),'_PhaseI','.txt'];
